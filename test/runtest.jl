...
@testset "Colname Determine" begin
    ...
    @test XLSXasJSON.parse_keyname("grouped{}")[1] == XLSXasJSON.JSONGroup
...
@testset "JSONData Types" begin
    ...
    @test JSON.json(d) == """[{"arr":[{"A":"string","B":100},{"A":"STRING","B":1000.1}]},{"arr":[{"A":null,"B":200},{"A":"TEST","B":2000.1}]}]"""
end
